...
public class KdproxyPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "kdproxy", binaryMessenger: registrar.messenger())
    let instance = KdproxyPlugin()
